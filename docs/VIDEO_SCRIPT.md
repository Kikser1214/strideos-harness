...
Record one clean first run, then edit to the timeline below. Use 1080p or higher, hide notifications, and never show credentials, MFA, cookies, tokens, email, or private health details. The final YouTube upload must be public and shorter than three minutes.
