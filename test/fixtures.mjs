export function completeProfile(overrides = {}) {
  const base = {
    ...
    delivery: { dashboard: true, workoutDelivery: false, connectorSetupMode: "not_now", morningBrief: true, preWorkoutBrief: true, postWorkoutReflection: true, weeklyReview: true, approvalMode: "ask_every_time", cloudProcessing: false, photoRetention: "do_not_retain" }
  };
