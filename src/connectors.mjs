...
const staticConnectors = [
  ...
  },
  {
    ...
    note: "HealthKit permission and reading must happen inside an authorized iOS companion app. This web harness cannot read Apple Health directly.",
    setup: { kind: "native_companion", platform: "iOS", permissionModel: "per health data type" }
  },
  {
    ...
    note: "Health Connect requires an Android companion app, declared data types, and user-granted permissions.",
    setup: { kind: "native_companion", platform: "Android", permissionModel: "per record type" }
  },
  ...
  { id: "polar", label: "Polar", route: "oauth", status: "planned", canRead: true, canWrite: false, note: "Polar AccessLink support is planned. File import is available now." },
  { id: "coros", label: "COROS", route: "partner_or_relay", status: "planned", canRead: true, canWrite: false, note: "Partner access may be required. Strava or file import is the current route." },
  { id: "suunto", label: "Suunto", route: "partner_or_relay", status: "planned", canRead: true, canWrite: false, note: "Partner access may be required. Strava or file import is the current route." },
  {
  ...
  return [
    {
      ...
      setup: { kind: "server_bridge", requiredEnvironment: ["GARMIN_BRIDGE_URL"], optionalEnvironment: ["GARMIN_BRIDGE_TOKEN"] }
    },
