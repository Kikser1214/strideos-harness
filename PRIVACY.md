...
- Operators are responsible for providing appropriate notice and consent, securing transport, controlling access, and meeting the obligations of the services and tools they choose.
...
- API/MCP/companion availability is evaluated separately from attended browser/computer use. The absence of an upstream API or a bundled reference-runtime executor does not authorize StrideOS to veto a user-selected host capability.
